       ...
       <aside id="sidebar" class="sidebar sidebar-expanded bg-stone-100/90 dark:bg-custom-gray " >
                    ...
                    <ul style="list-style:none;padding:0;margin:0;">
                        ...
                        <li>
                            <div class="transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 mb-2" >
                                <a href="{{ route('deforestation.create') }}" class="nav-item {{ request()->routeIs('deforestation.*') ? 'active' : '' }} transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                        ...
                        <li>
                            <div class="transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 mb-2">
                                <a href="{{ route('polygons.index') }}" class="nav-item {{ request()->routeIs('polygons.*') ? 'active' : '' }} transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                                    ...
                                    <span class="sidebar-text whitespace-nowrap">Poligonos</span>
                                </a>
                            </div>
                        </li> 
                        ...
                        <li>
                            <div class="transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 mb-2">
                                <a href="{{ route('producers.index') }}" class="nav-item {{ request()->routeIs('producers.*') ? 'active' : '' }} transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-sprout transition-all duration-500 group-hover:scale-[1.15] group-hover-ml-2">
                        ...
                        {{-- Este enlace se mostrará para técnicos y administradores --}}
                        @if (auth()->check() && in_array(auth()->user()->role, ['tecnico']))

                        <li>
                            <div class="transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 mb-2">
                                <a href="{{ route('backups.index') }}" class="nav-item {{ request()->routeIs('backups.*') ? 'active' : '' }} transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-database-backup-icon transition-all duration-500 group-hover:scale-[1.15] group-hover-ml-2">
            ...
            <!-- Sidebar Footer -->
             <div class="sidebar-header" style="padding-bottom:2rem;">
                <a href="{{ route('support') }}" class="nav-item transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                 
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-book-open-text-icon lucide-book-open-text transition-all duration-500 group-hover:scale-[1.15] group-hover-ml-2"><path d="M12 7v14"/><path d="M16 12h2"/><path d="M16 8h2"/><path d="M3 18a1 1 0 0 1-1-1V4a1 1 0 0 1 1-1h5a4 4 0 0 1 4 4 4 4 0 0 1 4-4h5a1 1 0 0 1 1 1v13a1 1 0 0 1-1 1h-6a3 3 0 0 0-3 3 3 3 0 0 0-3-3z"/>
                        <path d="M6 12h2"/><path d="M6 8h2"/>
                    </svg>
                    <span class="sidebar-text">Soporte</span>
                </a>
                <a href="{{ route('developers') }}"  class="nav-item transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
                    ...
                    <span class="sidebar-text">Desarrolladores</span>
                </a>
            </div> 
        </aside>
