            ...
            <nav style="flex:1;">
                <div style="margin-bottom:2rem;">
                    ...
                    <ul style="list-style:none;padding:0;margin:0;">
                        ...
                        <li>
                            <div class="transition-all duration-300 hover:scale-[1.03] hover:-translate-y-0.5 mb-2">
                                <a href="{{ route('polygons.index') }}" class="nav-item {{ request()->routeIs('areas.index') ? 'active' : '' }} transition-all duration-300 ease-in-out hover:font-bold hover:shadow-md group">
