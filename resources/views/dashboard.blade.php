    ...
    <div class="mx-auto">
        ...
        <div class="bg-stone-100/90 dark:bg-custom-gray rounded-xl shadow-lg p-6 mb-8">
            ...
            <div class="grid grid-cols-1 md:grid-cols-3 gap-4">
                ...
                <a href="{{ route('admin.audit') }}" class="group flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
                ...
                <a href="{{ route('profile.edit') }}" class="group flex items-center p-4 bg-gray-50 dark:bg-gray-700/50 rounded-lg hover:bg-gray-100 dark:hover:bg-gray-700">
