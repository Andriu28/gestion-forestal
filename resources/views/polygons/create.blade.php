...
class PolygonMap {
    ...
    setupBaseLayers() {
        ...
        this.baseLayers = {
            ...
            maptiler_satellite: new ol.layer.Tile({
                ...
                visible: true, // CAMBIADO: true - Esta será la capa principal
    ...
    setupMapInstance() {
        ...
        this.currentBaseLayer = this.baseLayers.maptiler_satellite; // CAMBIADO

        // Actualizar el texto del botón (NUEVO)
