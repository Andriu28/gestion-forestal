        ...
        <div class="bg-stone-100/90 dark:bg-custom-gray overflow-hidden shadow-sm rounded-2xl shadow-soft p-4 md:p-6 lg:p-6 mb-6">
            <div class="text-gray-900 dark:text-gray-100">
                ...
                <div class="flex justify-end mb-6">
                    ...
                    <!-- Botón para ver usuarios habilitados -->
                    <a href="{{ route('admin.users.index') }}" 
                    title="Ver usuarios habilitados" 
                ...
                <form method="GET" action="{{ route('admin.users.disabled') }}" class="mb-6">
                    <div class="flex flex-wrap gap-4">
                        ...
                        @if(request('search') || request('role'))
                            <a href="{{ route('admin.users.disabled') }}" class="px-4 py-2 bg-gray-400/90 hover:bg-gray-300 text-white rounded-lg transition-all flex items-center space-x-2"> 
                                    ...
                                    <tr id="disabled-user-row-{{ $user->id }}" class="hover:bg-gray-200/60 dark:hover:bg-gray-700/30 hover:shadow-lg hover:transition-all hover:duration-200">
                                        ...
                                        <td class="hover:bg-gray-200 dark:hover:bg-gray-600/20 px-6 py-4 whitespace-nowrap">
                                            <button onclick="handleUserEnable({{ $user->id }}, '{{ $user->name }}')" 
                                                    class="inline-flex items-center text-lime-600/50 hover:text-lime-600 dark:text-lime-500/60 dark:hover:text-lime-300 transition-colors p-1 hover:bg-gray-600 dark:hover:bg-gray-500/40 rounded-xl transition-all duration-300 hover:bg-opacity-10 hover:scale-110"
                                                    title="Habilitar">
