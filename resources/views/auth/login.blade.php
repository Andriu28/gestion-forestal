                    ...
                    <div class="space-y-1 sm:space-y-1.5">
                        ...
                        <div class="relative hover:-translate-y-1 duration-300">
                            <input
                                ...
                                class="w-full px-2.5 sm:px-4 py-1.5 sm:py-2 pr-8 text-sm sm:text-base border-[2px] border-stone-300/80 dark:border-gray-600 bg-white dark:bg-gray-800/50 text-custom-gray dark:text-gray-100 placeholder-gray-500 dark:placeholder-gray-400 rounded-xl shadow-sm transition-all duration-200 hover:scale-[1.02] outline-none ring-0 focus:outline-none focus:ring-2 focus:ring-amber-600/40 focus:border-amber-600/60 dark:focus:ring-amber-500/40 dark:focus:border-amber-500/60 transition-colors"
                            />
