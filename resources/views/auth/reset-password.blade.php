...
<x-guest-layout>
    <div class="w-full max-w-xs sm:max-w-sm md:max-w-lg ">
        ...
        <div class="card-glow shadow-2xl hover:shadow-3xl dark:shadow-gray-900/50 bg-stone-200/90 dark:bg-custom-gray rounded-2xl transition-all duration-300">
            ...
            <div class="px-3 sm:px-4 md:px-5 py-1 sm:py-2 pb-3 sm:pb-4">
                <h2 class="heading2 text-xl sm:text-2xl md:text-3xl lg:text-4xl text-center text-custom-dark dark:text-amber-100 font-black transition-colors">Restablecer Contraseña</h2>
            </div>

            <!-- Contenido del card -->
            <div class="px-3 sm:px-4 md:px-5 sm:pb-4">
                <form method="POST" class="space-y-2.5 sm:space-y-3 md:space-y-5" action="{{ route('password.store') }}">
                    @csrf
                    ...
                    <!-- Confirm Password -->
                    <div class="space-y-1 sm:space-y-1.5">
                        <label for="password_confirmation" class="block text-custom-dark dark:text-amber-100 font-medium text-sm sm:text-base transition-colors">
                        ...
                        <div class="relative hover:-translate-y-1 duration-300">
                            ...
                            >
                                <!-- Icono de ojo cerrado (por defecto) -->
                                <svg id="eyeOffConfirmation" class="w-5 h-5 sm:w-6 sm:h-6" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M13.875 18.825A10.05 10.05 0 0112 19c-4.478 0-8.268-2.943-9.543-7a9.97 9.97 0 011.563-3.029m5.858.908a3 3 0 114.243 4.243M9.878 9.878l4.242 4.242M9.878 9.878L3 3m6.878 6.878L21 21"></path>
                                </svg>
                                <!-- Icono de ojo abierto (oculto por defecto) -->
                                <svg id="eyeOnConfirmation" class="w-5 h-5 sm:w-6 sm:h-6 hidden" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M15 12a3 3 0 11-6 0 3 3 0 016 0z"></path>
                                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.478 0 8.268 2.943 9.542 7-1.274 4.057-5.064 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
                                </svg>
                            </button>
    ...
    <script>
        ...
        document.getElementById('togglePasswordConfirmation').addEventListener('click', function() {
            ...
            const eyeOff = document.getElementById('eyeOffConfirmation');
            const eyeOn = document.getElementById('eyeOnConfirmation');
